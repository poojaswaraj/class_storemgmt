...
$query1=mysqli_query($connection,"SELECT SUM(paid_amt) as a FROM receipt where cur_date='$date1' and user_id='$user_id' and payment_mode='cash'") or die(mysqli_error($connection));
	...
	$query4=mysqli_query($connection,"SELECT SUM(paid_amt) as d FROM receipt where cur_date='$date1' and user_id='$user_id' and d_name='Networking'") or die(mysqli_error($connection));
	...
	$query6=mysqli_query($connection,"SELECT SUM(paid_amt) as f FROM receipt where cur_date='$date1' and user_id='$user_id' and d_name='Development'") or die(mysqli_error($connection));
	$data66=mysqli_fetch_array($query6);
	
	$query7=mysqli_query($connection,"SELECT SUM(paid_amt) as g FROM receipt where cur_date='$date1' and user_id='$user_id' and d_name='Development SP'") or die(mysqli_error($connection));
	...
	$query12=mysqli_query($connection,"SELECT SUM(paid_amt) as l FROM receipt where cur_date='$date1' and user_id='$user_id' and d_name='Placement Development/Networking'") or die(mysqli_error($connection));
	...
	$query15=mysqli_query($connection,"SELECT cash FROM paytm where name='Nisha'") or die(mysqli_error($connection));
	$data155=mysqli_fetch_array($query15);
	$query16=mysqli_query($connection,"SELECT cash FROM paytm where name='Pawan'") or die(mysqli_error($connection));
	$data166=mysqli_fetch_array($query16);
	$query211=mysqli_query($connection,"SELECT SUM(r_cash) as v FROM add_expense where date='$date1' and user_id='$user_id' ") or die(mysqli_error($connection));
	$data211=mysqli_fetch_array($query211);
	$query311=mysqli_query($connection,"SELECT SUM(cashback) as v FROM add_expense where date='$date1' and user_id='$user_id' ") or die(mysqli_error($connection));
	$data333=mysqli_fetch_array($query311);
	$data199[0]=$data11[0]-$data133[0]+$data211[0];
    $data200[0]=$data22[0]-$data177[0];
    $data444[0]=$data155[0]+$data166[0];

    $sum[0]=$data11[0]+$data22[0]+$data33[0]+$data211[0]+$data333[0]+$data444[0]-($data133[0]+$data144[0]+$data177[0]);
    $array=array($data11[0],$data22[0],$data33[0],$data44[0],$data55[0],$data66[0],$data77[0],$data88[0],$data99[0],$data100[0],$data111[0],$data122[0],$sum[0],$data133[0],$data144[0],$data155[0],$data166[0],$data177[0],$data188[0],$data199[0],$data200[0],$data211[0],$data444[0]);
