	...
	<div class="col-lg-12" id="reportdata">
		...
		<table class="datatable table table-striped" id="example" cellspacing="0" width="100%">
			  ...
			  <?php 
			  	...
			  	if($utype=='admin')
			  	{
			  		$query = mysqli_query($connection,"SELECT * FROM common WHERE user_id='$user_id'")or die(mysqli_error($connection));
			  		
			  		
      		 	}
      		 	else{
			  		$query = mysqli_query($connection,"SELECT * FROM common WHERE  user_id='$sub_id'")or die(mysqli_error($connection));
