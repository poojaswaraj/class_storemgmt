...
$insert="INSERT INTO `generate_log`(`sche_type`, `cur_date`, `cur_time`, `en_remark`,`student_id`,`generated_by`,`status`,`user_id`) VALUES
	('$sche_type',current_date(),'$data222','$en_remark','$id','$sess_id11','active','$sess_id11')";
