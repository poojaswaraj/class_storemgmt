...
?>
	...
	<div class="col-lg-12">
		...
		<!-- <div class="col-md-3">
			<label>Permanent Address <label style="color:red;">*</label></label><textarea class="form-control" id="pmt_add" name="pmt_add" placeholder="Permanent Address"><?php echo $data['pmt_address'];?></textarea>
		</div> -->
			<div class="col-md-3">
	...
	if(document.pressed == 'save')
	  {
	  	...
	  	if(txt_mobno.length>=10 && txt_mobno.length<11)
             	{  
