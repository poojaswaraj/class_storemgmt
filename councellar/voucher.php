...
<div class="row">
	...
	<div class="col-lg-12">
		...
		<input type="hidden" name="user_id" id="user_id" value="<?php echo $sub_id;?>"/>
...
<div class="col-md-12">
  <h4>Recent Expenses</h4>
      ...
      <thead>
        ...
        <tbody>
        <?php
       $query12=mysqli_query($connection,"SELECT * FROM expenses WHERE user_id='$sub_id' ORDER BY date DESC")or die(mysqli_error($connection));
