...
<input type="hidden" name="new_id" value="<?php echo $c_id; ?>">	
	...
	<?php
     ...
     $row=mysqli_query($connection,"select SUM(paid_amt) as total from receipt where invoice_id=$id ");
      ...
      <div class="col-md-3"><label for="txt_total_amount1">Paid Receipt Amount<label style="color:red;">*</label></label>
		<input type="text" class="form-control" name="txt_paid_receipt" id="txt_paid_receipt"  value="0" placeholder="Paid Receipt Amount">
	</div>
	<?php
       }
       else
       {
		...
		<div class="col-md-3"><label for="txt_total_amount1">Paid Receipt Amount<label style="color:red;">*</label></label>
		<input type="text" class="form-control" name="txt_paid_receipt" id="txt_paid_receipt"  value="<?php echo $data['total'];?>" placeholder="Paid Receipt Amount">
	</div>
	<?php
     }
...
$sub=mysqli_query($connection,"SELECT MAX(fees_due_date) as a FROM receipt WHERE user_id='$sub_id' and s_id='$c_id'")or die(mysqli_error($connection));
$res=mysqli_fetch_array($sub);
   $data1=$res['a'];
   if($data1==0)
   {
    ?>
      <div class="col-md-3"><label for="txt_fine_amount">Fine Amount</label>
...
if(-7>$days)
{
  $days_value=-7-($days);
 ?>
 <div class="col-md-3"><label for="txt_remaing_amount">Fine Amount</label>
...
else
{
  ...
  <div class="col-md-3"><label for="txt_remaing_amount">Fine Amount</label>
    ...
    ?>
		...
		<div class="col-md-2"><label for="txt_semail">Select Series<label style="color:red;">*</label></label><select class="form-control" name="select_series" id="select_series" required>
...
<option value="">Select Series</option>
      ...
      <?php
      $qry2=mysqli_query($connection,"SELECT * FROM `series`");
    ...
    <div class="col-md-1"><label for="ser_no">Series No<label style="color:red;">*</label></label>
      <input type="text" class="form-control" name="ser_no" id="ser_no" readonly="">
        ...
        <div class="col-md-3"><label for="txt_semail">Contact Person <label style="color:red;">*</label></label><select class="form-control" name="txt_cperson" id="txt_cperson" required>
...
<option value="">Select Contact</option>
      ...
      $role="Manager";
      $qry2=mysqli_query($connection,"SELECT * FROM `user_profile` where user_id='$sub_id' and department_id='$d_id' or user_role='$role' ");
        while($row2=mysqli_fetch_array($qry2))
        {
      ?>
      ...
      <?php } ?>
		...
		<div class="col-md-3"><label for="txt_contact">Contact No<label style="color:red;">*</label></label>
			<input type="text" class="form-control" name="txt_contact" id="txt_contact"  placeholder="Contact No">
		</div>
		<div class="col-md-3"><label for="txt_book">Mode Of Payment<label style="color:red;">*</label></label>
			<select class="form-control" name="payment" id="payment" required>
       <option value="">Select Payment</option>
            		      <?php
      $qry2=mysqli_query($connection,"SELECT * FROM `mode` WHERE user_id='$sub_id'");
        while($row2=mysqli_fetch_array($qry2))
        {
      ?>
    ...
    <label for="txt_book">Paytm Account</label>
      ...
      <?php } ?>
			...
			<div class="col-md-3"><label for="txt_semail">Book Code</label>
...
{	
	...
	var paid_resc = document.getElementById('txt_paid_receipt').value;
