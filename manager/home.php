...
include('config.php');
 ...
 $sub=mysqli_query($connection,"SELECT * FROM user_profile WHERE type='$utype' ")or die(mysqli_error($connection));
 $array=mysqli_fetch_array($sub);
 $sub_id=$array['user_id'];
  $user_role=$array['user_role'];
 $sub1=mysqli_query($connection,"SELECT * FROM user  ")or die(mysqli_error($connection));
	...
	<div class="col-lg-12">
			...
			<table class="datatable table table-striped" id="example" cellspacing="0" width="100%">
			  ...
			  <?php 
			  	...
			  	if($utype=='admin')
			  	{
      		 		$query = mysqli_query($connection,"SELECT * FROM receipt  order by fees_due_date DESC ")or die(mysqli_error($connection));
      		 	}
      		 	else{
      		 		$query = mysqli_query($connection,"SELECT * FROM receipt  order by fees_due_date DESC")or die(mysqli_error($connection));
      		 	}
	...
	<div class="col-lg-12" id="reportdata">
		...
		<table class="datatable table table-striped" id="example" cellspacing="0" width="100%">
			  ...
			  <?php 
			  	...
			  	if($utype=='admin')
			  	{
			  		$query = mysqli_query($connection,"SELECT * FROM receipt order by fees_due_date ")or die(mysqli_error($connection));
      		 	}
      		 	else{
			  		$query = mysqli_query($connection,"SELECT * FROM receipt order by fees_due_date ")or die(mysqli_error($connection));
      		 	}
    ...
    <div class="modal-dialog modal-md">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">    
                ...
                <input type="hidden" name="invoice_id" id="invoice_id">
                 <input type="hidden" name="user_id" id="hidd" value="<?php echo $sub_id; ?>">
