...
<div class="panel-body">
    ...
    <div class="tab-content">
        ...
        <div class="col-lg-12" id="globset">
           ...
           <?php
			$aa = mysqli_query($connection,"SELECT * FROM company ")or die(mysqli_error($connection));
        ...
        <div class="tab-pane fade" id="setting">
            ...
            <?php 
            	...
            	$sql=mysqli_query($connection,"SELECT u.name,c.* FROM company c inner join user_profile u on u.id=c.user_id WHERE c.user_id='$user_id'")or die(mysqli_error($connection));
            ...
            <div class="col-lg-6">
				...
				<div class="col-md-6">
					<input type="text" class="form-control" name="txt_cname" id="txt_fname" value="<?php echo $row['company_name']; ?>" placeholder="Company Name" required>
				</div>
				<div class="panel-body"></div>
				...
				<div class="col-md-6">
					<input type="text" class="form-control" name="txt_cont" id="txt_cont" value="<?php echo $row['company_phone']; ?>" placeholder="Contact No" required>
				</div>
				<div class="panel-body"></div>
				...
				<div class="col-md-6">
					<input type="email" class="form-control" name="txt_email" id="txt_email" value="<?php echo $row['company_email']; ?>" placeholder="Email" required>
				</div>
