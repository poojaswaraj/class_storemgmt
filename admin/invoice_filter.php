...
// while($row5=mysqli_fetch_array($sql11))
// 			{
			$sql11=mysqli_query($connection,"SELECT * from common WHERE date(created_at) BETWEEN  '$fromdate' AND '$todate' ORDER BY created_at DESC ")or die(mysqli_error($connection));
			$rowcount1=mysqli_num_rows($sql11);
			// }
			?>
