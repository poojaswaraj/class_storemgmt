...
<div class="col-lg-9">
	<div class="col-md-6">
		<input type="text" class="form-control" name="name" id="name" placeholder="student  Name" style="text-transform:capitalize;"  onkeyup="cust();" required="" value="<?php if(isset($_GET["id"])){ echo $data['student_name'];} else {}?>">
	</div>
	<!--<div class="col-md-3">-->
	<!--	<input type="text" class="form-control" name="txt_cleagal_id" id="txt_cleagal_id" placeholder="Student PAN No." value="<?php if(isset($_GET["id"])){ echo $data['student_identification'];} else {}?>">-->
	<!--</div>-->
	<!--<div class="col-md-3">-->
	<!--	<input type="text" class="form-control" name="txt_gstno" id="txt_gstno" placeholder="Student GST Number" value="<?php if(isset($_GET["id"])){ echo $data['stu_gst_no'];} else {}?>">-->
	<!--</div>-->
	...
	<div class="col-md-6">
		...
		<div class="col-md-6">
			<input type="text" class="form-control" name="txt_cperson" id="txt_cperson" placeholder="Student Mobile No" required="" value="<?php if(isset($_GET["id"])){ echo $data['contact_person'];} else {}?>" >
		</div>

		<div class="col-md-6">
			<input type="text" class="form-control" name="txt_cemail" id="txt_cemail" placeholder="Student Email Address" required="" value="<?php if(isset($_GET["id"])){ echo $data['email'];} else {}?>"  >
		</div>

		<div class="panel-body"></div>

		<div class="col-md-6">
			<input type="text" class="form-control" name="txt_state" id="txt_state" placeholder="State" onkeyup="state()" required="" value="<?php if(isset($_GET["id"])){ echo $data['invoice_state'];} else {}?>" >
		</div>

		<div class="col-md-6">
			<input type="text" class="form-control" name="txt_code" id="txt_code" placeholder="State Code" readonly="" value="<?php if(isset($_GET["id"])){ echo $data['in_state_code'];} else {}?>" >
		</div>
	...
	<div class="col-md-6">
		...
		<div class="col-md-6">
			<input type="text" class="form-control" name="txt_scperson" id="txt_scperson" placeholder=" Student Mobile No" value="<?php if(isset($_GET["id"])){ echo $data['ship_cont_person'];} else {}?>">
		</div>

		<div class="col-md-6">
			<input type="text" class="form-control" name="txt_scemail" id="txt_scemail" placeholder="Student Email Address" value="<?php if(isset($_GET["id"])){ echo $data['ship_email'];} else {}?>"  >
		</div>

		<div class="panel-body"></div>

		<div class="col-md-6">
			<input type="text" class="form-control" name="txt_sstate" id="txt_sstate" placeholder="State" onkeyup="state_ship();" value="<?php if(isset($_GET["id"])){ echo $data['ship_state'];} else {}?>"  >
		</div>

		<div class="col-md-6">
			<input type="text" class="form-control" name="txt_scode" id="txt_scode" placeholder="State Code" value="<?php if(isset($_GET["id"])){ echo $data['ship_state_code'];} else {}?>" >
		</div>
...
<div class="col-lg-12">
	...
	<select class="form-control" name="select_series" id="select_series">
		<?php
			$query = mysqli_query($connection,"SELECT a.* FROM series a INNER JOIN common b ON a.id=b.series_id WHERE b.id='$id'");
				$row1=mysqli_fetch_array($query);
		 ?>
			<option value="<?php echo $row1['id'];?>"><?php echo $row1['name'];?></option>

 		<!-- <?php
			$query = mysqli_query("SELECT * FROM series");
	...
	<div class="col-md-2">
		<input type="date" class="form-control" name="idate" id="idate" required value="<?php if(isset($_GET["id"])){ echo $data['issue_date'];} else {}?>">
	</div>
	<div class="col-md-1">
  ...
  <div class="panel panel-default">
	...
	<!-- 	  <th>Qty</th> -->
	  ...
	  <?php
		...
		$sq = mysqli_query($connection,"SELECT b.course,b.ccode,b.description,a.* FROM `item` a INNER JOIN `course` b ON a.product_id=b.id LEFT JOIN common c ON c.id=a.common_id WHERE  a.common_id='$id' and a.status=1")or die(mysqli_error($connection));
...
<?Php?>
	...
	<button type="submit" class="btn btn-primary" name="print_button" id="print_button" value="Print" onclick="openWin()" ><span class="glyphicon glyphicon-print"></span>&nbsp;Print</button> 
						...
						success: function(data)
						{
							...
							if(data==3)
							{
								...
								//  window.location.href= "logproduct.php";
								 ...
								 // logproduct.php?us_ty=<?php echo $utype; ?>
