<?php
 ...
 $message11='Yes';
	...
	if(isset($_GET['ed']) && !empty($_GET['ed']))
		{
			 $id=$_GET['ed'];
			$run1 = mysqli_query($connection,"SELECT * FROM user_profile where id='$id' 	");
	...
	<div clss="row">
		<div class="col-lg-12">
			<div class="col-md-4">
	            ...
	            <?php 
	            $qry11=mysqli_query($connection,"SELECT COUNT(id) as count FROM common where sub_user_id='$id' ")or die(mysqli_error($connection));
	...
	<div class="col-lg-12" id="reportdata">
		...
		<table class="datatable table table-striped" id="example" cellspacing="0" width="100%">
			...
			$sub_id=$array['user_id'];
				...
				$qry=mysqli_query($connection,"SELECT * FROM common where sub_user_id='$id' ORDER BY `id` DESC")or die(mysqli_error($connection));
