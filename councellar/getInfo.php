...
include "config.php";
 ...
 $id=$_POST['eid'];
  $hidd=$_POST['hidd'];
  $hidd11=$_POST['hidd11'];
	$query = mysqli_query($connection,"select * from receipt where id='$id'  and user_id='$hidd11' ")or die(mysqli_error($connection));
		...
		$query1 = mysqli_query($connection,"select company_name,company_phone from company where user_id='$hidd11'")or die(mysqli_error($connection));
