...
<div class="col-lg-9">
	...
	<div class="col-md-6">
		...
		<div class="col-md-6">
			<input type="text" class="form-control" name="txt_cperson" id="txt_cperson" placeholder="Student Mobile No">
		</div>
	...
	<div class="col-md-6">
		...
		<div class="col-md-6">
			<input type="text" class="form-control" name="txt_scperson" id="txt_scperson" placeholder="Student Mobile No">
		</div>
...
<script type="text/javascript">
 ...
 function auto(){
    ...
    $("#txt_course").autocomplete({
        source: 'autocomplete.php?u_id=<?php echo $user_id;?>',
        select: function(a,b)
	        {
	            $(this).val(b.item.value); //grabed the selected value
...
// This function is used for customer suggesions and fetch values
 function cust(){
    ...
    $("#name").autocomplete({
        source:'stud_autocomplete.php?u_id=<?php echo $user_id;?>', 
        select: function(a,b)
	        {
	            $(this).val(b.item.value); //grabed the selected value
