...
{
	// echo "0";
	$sql21 = mysqli_query($connection,"UPDATE course SET `user_id`='$sub_id',`sub_user_id`='$user_id',`base_price`='$txt_cost',`updated_at`='$dt',`session`='$s_id',`ccode`='$txt_ccode' WHERE id='$pr_id'")or die(mysqli_error($connection));

			if($sql21==true)
			{
				  $last_id1 = mysqli_insert_id($connection);
					
				$sql31 = mysqli_query($connection,"INSERT INTO item (`user_id`,`sub_user_id`,`quantity`,`discount`,`tax_amt`,`disc_amt`,`common_id`,`product_id`,`unitary_cost`,`price`,`session`,`state_code`,`status`,`type`,`ccode`) VALUES ('$sub_id','$user_id','$txt_qty','$txt_discount','$txt_amt','$disc_amt','$data','$pr_id','$txt_cost','$txt_price','$s_id','$txt_code','1','invoice','$txt_ccode')")or die(mysqli_error($connection));
	...
	$sql2 = mysqli_query($connection,"INSERT INTO course (`user_id`,`sub_user_id`,`course`,`base_price`,`created_at`,`session`,'ccode') VALUES ('$sub_id','$user_id','$txt_course','$txt_cost','$dt','$s_id','$txt_ccode')")or die(mysqli_error($connection));
...
{
	// echo "0";
	$sql21 = mysqli_query($connection,"UPDATE course SET `user_id`='$user_id',`sub_user_id`='$sub_id',`base_price`='$txt_cost',`updated_at`='$dt',`session`='$s_id',`ccode`='$txt_ccode' WHERE id='$pr_id'")or die(mysqli_error($connection));
