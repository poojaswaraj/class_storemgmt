...
?>
    ...
    <div class="panel-heading">Student Details <label style="margin-left:695px;">Date:&nbsp;&nbsp;<?php echo date("y/m/d"); ?></label></div>
        <div class="panel-body">  
			...
			<div class="col-md-6"><?php echo $comment; ?></div>
					...
					?>
			<div class="col-sm-4">
			<div class="col-md-6"><label>Generated By:</label></div>
			<div class="col-md-6"><?php echo $g_name; ?></div>
			</div>
			...
			<div class="col-md-6"><label style="color:blue;"><?php echo $assign_to_name; ?></label></div>
			</div>
 ...
 <div class="panel panel-primary">
   ...
   <thead>
	...
	echo"<tr>
		<td>$count</td>
		<td>$date1&nbsp;$cur_time</td>		
                <td>".$row6['sche_type']."</td> 
                 <td>$en_remark</td>              
                	
		               
                <td>$en_status</td>
                <td>$date2&nbsp;$sche_time</td>	
