...
<?php 
	...
	<div class="col-md-2">
		...
		<select class="form-control" name="type" id="type" >
			...
			<?php
			$mode_qu=mysqli_query($connection,"SELECT * FROM user_profile ")or die(mysqli_error($connection));
	...
	<div class="col-md-2">
		...
		<select class="form-control" name="type1" id="type1" >
			...
			<?php
			$mode_qu1=mysqli_query($connection,"SELECT * FROM mstr_schedule ")or die(mysqli_error($connection));
