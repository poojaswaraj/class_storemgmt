...
<!-- <div class="col-md-12">
	<div class="col-md-2" id="in_1">
		<div class="small-box bg-aqua">
	        <div class="inner">
	    <?php 
$sql=mysqli_query($connection,"SELECT * from common where user_id='$sub_id' and d_name='$d_id'")or die(mysqli_error($connection));
 ...
 $rowcount=mysqli_num_rows($sql);
	...
	<div class="col-md-2" id="in_1">
		<div class="small-box bg-aqua"> 
	        <div class="inner">
	       		              <?php 
$sql=mysqli_query($connection,"SELECT sum(due_amt) as a,sum(gross_amount) as b  from common  where user_id='$sub_id' and d_name='$d_id'")or die(mysqli_error($connection));
...
$data=$data2-$data1;
		...
		<div class="small-box bg-aqua">
	        <div class="inner">
				            <?php 
$sql=mysqli_query($connection,"SELECT sum(due_amt) as a from common  where user_id='$sub_id' and d_name='$d_id'")or die(mysqli_error($connection));
 $rowcount=mysqli_fetch_array($sql);
 $data=$rowcount['a'];
	...
	<div class="col-md-2" id="in_1">
		<div class="small-box bg-aqua">
	        <div class="inner">
	        	          <?php 
$sql=mysqli_query($connection,"SELECT sum(gross_amount) as a from common  where user_id='$sub_id' and d_name='$d_id'")or die(mysqli_error($connection));
 $rowcount=mysqli_fetch_array($sql);
 $data=$rowcount['a'];
...
<?php	 if(isset($_GET["id"]))
 ...
 $query4 = mysqli_query($connection,"SELECT * FROM receipt ")or die(mysqli_error($connection));
			  echo	$count=mysqli_num_rows($query4);
			  	$data1=mysqli_fetch_array($query4);
			  echo	$receipt_series=$data1['receipt_series'];
			  ?>
<div class="row">
	...
	<div class="col-lg-12">
			...
			<table class="datatable table table-striped" id="example" cellspacing="0" width="100%">
			  ...
			  <?php 
			  	...
			  	if($utype=='admin')
			  	{
      		 		$query = mysqli_query($connection,"SELECT * FROM receipt  where user_id='$sub_id' and d_name='$d_id' order by fees_due_date DESC ")or die(mysqli_error($connection));
      		 	}
      		 	else{
      		 		$query = mysqli_query($connection,"SELECT * FROM receipt  where user_id='$sub_id' and d_name='$d_id' order by fees_due_date DESC")or die(mysqli_error($connection));
      		 	}
			   ...
			   ?>
				<tr id="invoice-23">
				  ...
				  <td><?php echo $row['receipt_series'];?></td>
...
<div class="col-lg-12" id="filter"> 
   ...
   <input type="hidden" name="us_id" id="us_id" value="<?php echo $sub_id; ?>">
	...
	<div class="col-lg-12" id="reportdata">
		...
		<table class="datatable table table-striped" id="example" cellspacing="0" width="100%">
			  ...
			  <?php 
			  	...
			  	if($utype=='admin')
			  	{
			  		$query = mysqli_query($connection,"SELECT * FROM receipt where user_id='$sub_id' and d_name='$d_id' order by fees_due_date")or die(mysqli_error($connection));
      		 	}
      		 	else{
			  		$query = mysqli_query($connection,"SELECT * FROM receipt  where user_id='$sub_id' and d_name='$d_id' order by fees_due_date")or die(mysqli_error($connection));
      		 	}
