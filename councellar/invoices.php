...
include('config.php');
 ...
 $sub=mysqli_query($connection,"SELECT * FROM user_profile WHERE type='user' and id='$user_id'")or die(mysqli_error());
	...
	<div class="col-lg-12">
			...
			<table class="datatable table table-striped" id="example" cellspacing="0" width="100%">
			  ...
			  <?php 
			  	...
			  	if($utype=='admin')
			  	{
      		 		$query = mysqli_query($connection,"SELECT * FROM common WHERE customer_id='$id' and d_name='$d_id'")or die(mysqli_error($connection));
      		 	}
      		 	else{
      		 		$query = mysqli_query($connection,"SELECT * FROM common WHERE customer_id='$sub_id' and d_name='$d_id'")or die(mysqli_error($connection));
      		 	}
	...
	<div class="col-lg-12" id="reportdata">
		...
		<table class="datatable table table-striped" id="example" cellspacing="0" width="100%">
			  ...
			  <?php 
			  	...
			  	if($utype=='admin')
			  	{
			  		$query = mysqli_query($connection,"SELECT * FROM common WHERE user_id='$sub_id' and d_name='$d_id'")or die(mysqli_error($connection));
