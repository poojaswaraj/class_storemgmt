...
<h3>Add Expenses<a  href="dashboard.php?page=voucher" style="float:right;"> + Back</a></h3>
	...
	<div class="col-lg-9">
		...
		<input type="hidden" name="user_id" value="<?php echo $sub_id;?>"/>
		<input type="hidden" name="sub_us_id" value="<?php echo $user_id; ?>">
		<div class="col-md-4">
		...
		<div class="col-md-4">
			<input type="text" class="form-control" name="base_amt" id="base_amt"  placeholder="Base Amount" onkeyup="taxoncalculation();" required="">
		</div>
		<div class="col-md-4">
      ...
      <div class="btn-group col-md-3" >
       ...
       <input type="hidden" class="form-control" name="tax_amt" id="tax_amt" placeholder="Tax Amount " onkeyup="taxoncalculation();">
		...
		<div class="col-md-4">
			...
			if($utype=='admin')
			{
				$sql = mysqli_query($connection,"SELECT * FROM mode WHERE user_id='$sub_id'")or die(mysqli_error($connection));
			}
			else{
				$sql = mysqli_query($connection,"SELECT * FROM mode WHERE user_id='$sub_id'")or die(mysqli_error($connection));
			}
...
<div class="col-md-12">
  <h4>Recent Expenses</h4>
      ...
      <thead>
        ...
        <tbody>
        <?php
        $sql12 = mysqli_query($connection,"SELECT * FROM add_expense WHERE user_id='$sub_id'")or die(mysqli_error($connection));
