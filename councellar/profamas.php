...
$user_id=$_SESSION['login_user'];
 ...
 $sub1=mysqli_query($connection,"SELECT * FROM user where id='$sub_id' ")or die(mysqli_error($connection));
			...
			<table class="datatable table table-striped" id="example" cellspacing="0" width="100%">
			  ...
			  <?php 
			  	...
			  	if($utype=='admin')
			  	{
      		 		...
      		 		$query = mysqli_query($connection,"SELECT * FROM receipt WHERE sub_user_id='$user_id' and d_name='$d_id' order by fees_due_date DESC ")or die(mysqli_error($connection));
      		 	}
		...
		var sel_duration =$('#sel_duration').val();
		    ...
		    $.ajax({	
					    ...
					    data:{
						        ...
						        toDate:toDate,
						        us_id:us_id,
						        sub_id:sub_id,sel_duration:sel_duration
					    },
					    success:function(data)
					    {
					      // alert(data);
