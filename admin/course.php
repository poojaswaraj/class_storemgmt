	...
	<div class="col-lg-9">
		...
		<div class="col-md-4">		
			...
			if(isset($data['id']))
			{
                ...
                <?php
			$qry2=mysqli_query($connection,"SELECT * FROM `department` WHERE user_id='$user_id' ");
		...
		<div class="col-md-4">
			...
			<input type="text" class="form-control" name="duration" value="<?php echo $data['duration'];?>" placeholder="Course Duration">
		</div>
...
<div class="col-md-12">
  <h4>Course List</h4>
      ...
      <thead>
        ...
        if($utype=='admin')
		{
			$qry=mysqli_query($connection,"SELECT * FROM course WHERE user_id='$user_id' ORDER BY `id` DESC")or die(mysqli_error($connection));
		}
		else{
			$qry=mysqli_query($connection,"SELECT * FROM course WHERE user_id='$user_id' ORDER BY `id` DESC")or die(mysqli_error($connection));
		}
