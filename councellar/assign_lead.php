	    ...
	    <tbody>
	     <?php 
			...
			$d_id=$array['department_id'];
				...
				$qry=mysqli_query($connection,"SELECT * FROM student where user_id='$sub_id' and d_name='$d_id' ORDER BY `id` DESC")or die(mysqli_error($connection));
				...
				while($row = mysqli_fetch_array($qry))
				{
					...
					$sql = mysqli_query($connection,"SELECT * FROM user_profile where user_id='$sub_id' and id='$generated'");
      ...
      <div class="panel-body">
		...
		<div class="col-md-4">		
			...
			<select name="employee"  class="form-control">
                            ...
                            <?php
			$qry1=mysqli_query($connection,"SELECT * FROM `user_profile` where `user_id`='$sub_id' and department_id='$d_id'");
