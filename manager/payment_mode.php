...
include('config.php');
 ...
 $sub1=mysqli_query($connection,"SELECT * FROM user_profile where id='$user_id' ")or die(mysqli_error($connection));
 $array1=mysqli_fetch_array($sub1);
 $message11=$array1['sms'];
?> 
<div class="row" >
	
<h3>Mode Wise Report</h3> 
<hr>
...
<div class="col-lg-12" id="filter"> 
	<div class="col-md-2">
		<select class="form-control" name="type" id="type" >
			...
			<?php
			$mode_qu=mysqli_query($connection,"SELECT * FROM mode where user_id='$user_id' ")or die(mysqli_error($connection));
   ...
   <input type="text" name="us_id" id="us_id" value="<?php echo $sub_id; ?>">
	<div class="col-md-1">
