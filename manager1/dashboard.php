...
<body>
    ...
    $user_id=$_SESSION['login_user'];
      ...
      $aa12 = mysqli_query($connection,"SELECT * FROM company WHERE user_id='$user_id'")or die(mysqli_error($connection));
     ...
     <?php } ?>
       ...
       <div class="setting">
          ...
          <span class="setting-part">Welcome <?php
			   $query=mysqli_query($connection,"SELECT * FROM user WHERE id='".$_SESSION['login_user']."'");
                      ...
                      <li>
                       <a href="#" data-toggle="dropdown" class="dropdown-toggle">Report<b class="caret"></b></a>
                        ...
                        <li><a href="dashboard.php?page=employee_list">Employee List</a></li>
                         <li><a href="dashboard.php?page=councellar">Councellar Report</a></li>
                         <li><a href="dashboard.php?page=payment_mode">Payment Mode</a></li>
                         <li><a href="dashboard.php?page=department_wise">Department Wise</a></li>
                        <li><a href="dashboard.php?page=director_enq_list">Enquiry List</a></li>
                        <!--<li><a href="dashboard.php?page=daily_plan">Employee Wise Plan</a></li>-->
                       
                        
                          
                        <li><a href="dashboard.php?page=alert">Notification</a></li>
