...
<?php 
	...
	<div class="col-md-2">
		...
		<select class="form-control" name="type" id="type" >
			...
			<?php
			$mode_qu=mysqli_query($connection,"SELECT * FROM user_profile where user_id='$sub_id' and department_id='$d_id'")or die(mysqli_error($connection));
	...
	<div class="col-md-2">
		...
		<select class="form-control" name="type1" id="type1" >
			...
			<?php
			$mode_qu1=mysqli_query($connection,"SELECT * FROM mstr_schedule where user_id='$sub_id' ")or die(mysqli_error($connection));
   ...
   <input type="hidden" name="sub_us_id" id="sub_us_id" value="<?php echo $user_id; ?>">
