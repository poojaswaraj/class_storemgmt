...
$sql1 = mysqli_query($connection,"UPDATE student SET `user_id`='$user_id',`name`='$name',`name_slug`='$string',`contact_no`='$txt_cperson',`email`='$txt_cemail',`tmp_address`='$txt_iaddr',`pmt_address`='$txt_saddr' WHERE id='$data'")or die(mysqli_error($connection));
	...
	if($sql1==true)
	{
	   ...
	   $sql4 = mysqli_query($connection,"UPDATE common SET `user_id`='$user_id',`student_name`='$name',`email`='$txt_cemail',`invoicing_address`='$txt_iaddr',`shipping_address`='$txt_saddr',`contact_person`='$txt_cperson',`terms`='$txt_terms',`bank_details`='$txt_bank',`notes`='$txt_notes',`base_amount`='$txt_base',`discount_amount`='$txt_total_discount',`net_amount`='$txt_subtotal',`tax_amount`='$txt_total_tax',`gross_amount`='$txt_total',`amt_words`='$test',`due_amt`='$due_remain',`status`='Pending',`type`='Invoice',`issue_date`='$idate',`due_date`='$ddate',`updated_at`='$dt',`invoice_state`='$txt_state',`in_state_code`='$txt_code',`ship_cont_person`='$txt_scperson',`ship_email`='$txt_scemail',`ship_state`='$txt_sstate',`ship_state_code`='$txt_scode' WHERE id='$data'")or die(mysqli_error($connection));
