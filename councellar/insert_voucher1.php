...
include "config.php";
	...
	$sql_query = mysqli_query($connection,"INSERT INTO `add_expense`(`user_id`, `sub_user_id`,`date`,`party_name`,`txt_pert`,`txt_gst`,`txt_hsn`,`base_amt`,`select_tax`, `total_amt`,`sel_mode`,`cheque_no`,`cheque_dt`,`state`,`code`,`paytm_name`,`cashback`) VALUES ('$user_id','$sub_id','$txt_dt','$party_name','$txt_pert','$txt_gst','$txt_hsn','$base_amt','$select_tax','$total_amt','$sel_mode','$cheque_no','$cheque_dt','$state','$txt_code','$paytm_name','$cashback')")or die(mysqli_error($connection));
